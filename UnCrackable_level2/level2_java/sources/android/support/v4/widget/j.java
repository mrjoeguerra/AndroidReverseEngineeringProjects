...
public final class j {
    ...
    static class b extends a {
        ...
        @Override // android.support.v4.widget.j.d
        public void a(PopupWindow popupWindow, boolean z) throws IllegalAccessException, IllegalArgumentException {
            if (a != null) {
                try {
    ...
    static class d {
        ...
        public void a(PopupWindow popupWindow, int i) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            if (!b) {
                try {
