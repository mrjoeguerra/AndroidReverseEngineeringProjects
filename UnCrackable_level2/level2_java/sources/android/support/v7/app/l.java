...
class l {
    ...
    private static boolean c(Resources resources) throws IllegalAccessException, IllegalArgumentException {
        Object obj;
        if (!b) {
            try {
                a = Resources.class.getDeclaredField("mDrawableCache");
    ...
    private static boolean d(Resources resources) throws IllegalAccessException, IllegalArgumentException {
        Object obj;
        Object obj2;
        if (!h) {
            try {
