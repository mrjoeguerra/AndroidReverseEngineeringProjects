...
public final class l {
    ...
    private Drawable a(Context context, int i2, boolean z, Drawable drawable) throws Resources.NotFoundException {
    ...
    */
    ...
    Drawable a(Context context, int i2, boolean z) throws XmlPullParserException, Resources.NotFoundException, IOException {
        f(context);
    ...
    Drawable a(Context context, bb bbVar, int i2) throws XmlPullParserException, Resources.NotFoundException, IOException {
        Drawable drawableD = d(context, i2);
        if (drawableD == null) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    android.content.res.ColorStateList b(android.content.Context r3, int r4) throws android.content.res.Resources.NotFoundException {
        /*
            r2 = this;
